...
def pipeline(args):
    ...
    h_1, h_2, var_1, var_2 = heritability(gwas_snps, ld_scores, N1, N2)
    ...
    out = calculate(args.bfile, bed, args.thread, gwas_snps, N1, N2, h_1, h_2, var_1, var_2, pheno_corr, pheno_corr_var)
